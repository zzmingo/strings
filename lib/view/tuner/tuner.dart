...
import 'package:strings/view/tuner/settings.dart';
...
class _TunerPageState extends State<TunerPage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    this._tuner.start();
    eventBus.on(Events.SettingClicked, _toSettingsPage);
  }
  ...
  void dispose() {
    ...
    this._tuner.dispose();
    eventBus.off(Events.SettingClicked, _toSettingsPage);
  }
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        child: OutlineButton(
                          ...
                          onPressed: () => _toSettingsPage(null),
                        ),
                      ),
